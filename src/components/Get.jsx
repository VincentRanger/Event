...
const Get = () => {
 ...
 <div id='field' className='text-start mt-5'><label htmlFor="">Email Address</label>
 <div className='mt-1'>
 <input type="text" size={80} className='border border-gray-400 rounded-md' />
 </div>
 </div>

 <div id='field' className='text-start mt-5'><label htmlFor="">Phone Number </label>
 <div className='mt-1'>
 <input type="text" size={80} className='border border-gray-400 rounded-md' />
 </div>
 </div>

 <div id='field' className='text-start mt-5'><label htmlFor="">Wedding or Special Event Date</label>
 <div className='mt-1'>
 <input type="text" size={80} className='border border-gray-400 rounded-md' />
 </div>
 </div>

 <div id='field' className='text-start mt-5'><label htmlFor="">Event Location or considering</label>
 <div className='mt-1'>
 <input type="text" size={80} className='border border-gray-400 rounded-md' />
 </div>
 </div>

 <div id='field' className='text-start mt-5'><label htmlFor="">Who is your caterer if decided?</label>
 <div className='mt-1'>
 <input type="text" size={80} className='border border-gray-400 rounded-md' />
 </div>
 </div>

 <div id='field' className='text-start mt-5'><label htmlFor="">How many guests are you anticipating?</label>
 <div className='mt-1'>
 <input type="text" size={80} className='border border-gray-400 rounded-md' />
 </div>
 </div>

<div id='field' className='text-start mt-5'>
...
<div id='field' className='mt-5 text-start'>
...
<div id='field' className='text- center text-white mt-5'>
