...
<div className='grid grid-cols-5 justify-items-center items-center gap-10 mt-10 mx-10'>
...
<div className='w-screen h-200 top-25 absolute bg-emerald-100 opacity-40'>
